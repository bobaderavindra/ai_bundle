...
logger = logging.getLogger("risk.kafka")
...
class KafkaBus:
    def __init__(self) -> None:
        ...
        self.consumer_group = os.getenv("RISK_CONSUMER_GROUP", "risk-service")
        self.consume_topics = _csv_topics(
            os.getenv("RISK_CONSUME_TOPICS", "portfolio.trade.executed,optimization.events")
        )
        self.publish_topic = os.getenv("RISK_EVENT_TOPIC", "risk.events")
        self._max_cached_events = int(os.getenv("RISK_EVENT_CACHE_SIZE", "200"))
